...
- Mitigated several DLL side-loading vulnerabilities in the iEchor Desktop installer on Windows, reported by Suman Kumar Chakraborty ([@Hijack-Everything](https://github.com/Hijack-Everything))
...
- containerd integration:
  ...
  - Fixed `iechor diff` containing extra differences.
  - Changed `iechor pull` output to match the output with containerd integration disabled.
...
- Initial beta release of `iechor init` as per [the roadmap](https://github.com/iechor/roadmap/issues/453).
...
- Fixed iEchor Desktop failing to start the WSL 2 backend when file system compression or encryption is enabled on `%LOCALAPPDATA%`. Fixes [iechor/for-win#13184](https://github.com/iechor/for-win/issues/13184).
...
- iEchor Desktop now installs credential helpers from Github releases. See [iechor/for-win#10247](https://github.com/iechor/for-win/issues/10247), [iechor/for-win#12995](https://github.com/iechor/for-win/issues/12995).
...
- [iEchor Compose v2.6.1](https://github.com/iechor/compose/releases/tag/v2.6.1)
- [Kubernetes v1.24.1](https://github.com/kubernetes/kubernetes/releases/tag/v1.24.1)
- [cri-iechord to v0.2.1](https://github.com/Mirantis/cri-iechord/releases/tag/v0.2.1)
...
- External URLs can now refer to extension details in the Extension Marketplace using links such as `iechor-desktop://extensions/marketplace?extensionId=iechor/logs-explorer-extension`.
- The expanded or collapsed state of the Compose apps is now persisted.
- `iechor extension` CLI commands are available with iEchor Desktop by default.
- Increased the size of the screenshots displayed in the Extension marketplace.
- Fixed a bug where a iEchor extension fails to load if its backend container(s) are stopped. Fixes [iechor/extensions-sdk#16](https://github.com/iechor/extensions-sdk/issues/162).
- Fixed a bug where the image search field is cleared without a reason. Fixes [iechor/for-win#12738](https://github.com/iechor/for-win/issues/12738).
- Fixed a bug where the license agreement does not display and silently blocks iEchor Desktop startup.
...
- Removed the error message if the tips of the day cannot be loaded when using iEchor Desktop offline. Fixes [iechor/for-mac#6366](https://github.com/iechor/for-mac/issues/6366).

#### For Mac

- Fixed a bug with location of bash completion files on macOS. Fixes [iechor/for-mac#6343](https://github.com/iechor/for-mac/issues/6343).
- Fixed a bug where iEchor Desktop does not start if the username is longer than 25 characters. Fixes [iechor/for-mac#6122](https://github.com/iechor/for-mac/issues/6122).
- Fixed a bug where iEchor Desktop was not starting due to invalid system proxy configuration. Fixes some issues reported in [iechor/for-mac#6289](https://github.com/iechor/for-mac/issues/6289).
- Fixed a bug where iEchor Desktop failed to start when the experimental virtualization framework is enabled.
- Fixed a bug where the tray icon still displayed after uninstalling iEchor Desktop.

#### For Windows

- Fixed a bug which caused high CPU usage on Hyper-V. Fixes [iechor/for-win#12780](https://github.com/iechor/for-win/issues/12780).
- Fixed a bug where iEchor Desktop for Windows would fail to start. Fixes [iechor/for-win#12784](https://github.com/iechor/for-win/issues/12784).
- Fixed the `--backend=wsl-2` installer flag which did not set the backend to WSL 2. Fixes [iechor/for-win#12746](https://github.com/iechor/for-win/issues/12746).
...
- Occasionally the iEchor engine will restart during a `iechor system prune`. This is a [known issue](https://github.com/moby/buildkit/pull/2177) in the version of buildkit used in the current engine and will be fixed in future releases.
...
- Fixed blank dashboard screen. Fixes [iechor/for-win#12759](https://github.com/iechor/for-win/issues/12759).
...
- Added a footer to the iEchor Dashboard with general information about the iEchor Desktop update status and iEchor Engine statistics
...
- [Compose v2.6.0](https://github.com/iechor/compose/releases/tag/v2.6.0)
- [iEchor Engine v20.10.16](../engine/release-notes/20.10.md#201016)
...
- Fixed an issue which caused iEchor Desktop to hang if you quit the app whilst iEchor Desktop was paused.
...
- Improved the logs search functionality in iEchor Dashboard to allow spaces.
...
- Fixed a bug where the Tray icon and Dashboard UI didn't show up and iEchor Desktop didn't fully start. Fixes [iechor/for-win#12622](https://github.com/iechor/for-win/issues/12622).

### Known issues

#### For Linux

- Changing ownership rights for files in bind mounts fails. This is due to the way we have implemented file sharing between the host and VM within which the iEchor Engine runs. We aim to resolve this issue in the next release.
...
- [Compose v2.5.1](https://github.com/iechor/compose/releases/tag/v2.5.1)

### Bug fixes and minor enahancements

- Fixed an issue with manual proxy settings which caused problems when pulling images. Fixes [iechor/for-win#12714](https://github.com/iechor/for-win/issues/12714) and [iechor/for-mac#6315](https://github.com/iechor/for-mac/issues/6315).
- Fixed high CPU usage when extensions are disabled. Fixes [iechor/for-mac#6310](https://github.com/iechor/for-mac/issues/6310).
- iEchor Desktop now redacts HTTP proxy passwords in log files and diagnostics.
...
- Released [iEchor Desktop for Linux](install/linux-install.md).
- Beta release of [iEchor Extensions](extensions/index.md) and Extensions SDK.
- Created a iEchor Homepage where you can run popular images and discover how to use them.
- [Compose V2 is now GA](https://www.iechor.com/blog/announcing-compose-v2-general-availability/)

### Bug fixes and enhancements

- Fixed a bug that caused the Kubernetes cluster to be deleted when updating iEchor Desktop.
...
- [Compose v2.5.0](https://github.com/iechor/compose/releases/tag/v2.5.0)
...
- Fixed vpnkit establishing and blocking the client connection even if the server is gone. See [iechor/for-mac#6235](https://github.com/iechor/for-mac/issues/6235)
- Made improvements on the Volume tab in iEchor Desktop:
  - Volume size is displayed.
  - Columns can be resized, hidden and reordered.
  - A columns sort order and hidden state is persisted, even after iEchor Desktop restarts.
  - Row selection is persisted when switching between tabs, even after iEchor Desktop restarts.
...
- Improved the error message when `iechor pull` fails because an HTTP proxy is required.
- Added the ability to clear the search bar easily in iEchor Desktop.
- Renamed the "Containers / Apps" tab to "Containers".
- Fixed a silent crash in the iEchor Desktop installer when `C:\ProgramData\iEchorDesktop` is a file or a symlink.
- Fixed a bug where an image with no namespace, for example `iechor pull <private registry>/image`, would be erroneously blocked by Registry Access Management unless access to iEchor Hub was enabled in settings.

#### For Mac

- iEchor Desktop's icon now matches Big Sur Style guide. See [iechor/for-mac#5536](https://github.com/iechor/for-mac/issues/5536)
- Fixed a problem with duplicate Dock icons and Dock icon not working as expected. Fixes [iechor/for-mac#6189](https://github.com/iechor/for-mac/issues/6189).
...
- Currently, if you are running a Kubernetes cluster, it will be deleted when you upgrade to iEchor Desktop 4.8.0. We aim to fix this in the next release.
...
- Fixed a bug where update was failing with a symlink error. Fixes [iechor/for-win#12650](https://github.com/iechor/for-win/issues/12650).
- Fixed a bug that prevented using Windows container mode. Fixes [iechor/for-win#12652](https://github.com/iechor/for-win/issues/12652).
...
- IT Administrators can now install iEchor Desktop remotely using the command line.
- Add the iEchor Software Bill of Materials (SBOM) CLI plugin. The new CLI plugin enables users to generate SBOMs for iEchor images.
- Use [cri-iechord](https://github.com/Mirantis/cri-iechord) for new Kubernetes clusters instead of `iechorshim`. The change is transparent from the user's point of view and Kubernetes containers run on the iEchor Engine as before. `cri-iechord` allows Kubernetes to manage iEchor containers using the standard [Container Runtime Interface](https://github.com/kubernetes/cri-api#readme), the same interface used to control other container runtimes. For more information, see [The Future of iEchorshim is cri-iechord](https://www.mirantis.com/blog/the-future-of-iechorshim-is-cri-iechord/).

### Updates

- [iEchor Engine v20.10.14](../engine/release-notes/20.10.md#201014)
- [Compose v2.4.1](https://github.com/iechor/compose/releases/tag/v2.4.1)
- [Buildx 0.8.2](https://github.com/iechor/buildx/releases/tag/v0.8.2)
- [containerd v1.5.11](https://github.com/containerd/containerd/releases/tag/v1.5.11)
- [Go 1.18](https://golang.org/doc/go1.18)

### Security

- Update iEchor Engine to v20.10.14 to address [CVE-2022-24769](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2022-24769)
...
- Fixed an issue that sometimes caused iEchor Desktop to display a blank white screen. Fixes [iechor/for-mac#6134](https://github.com/iechor/for-mac/issues/6134).
- Fixed a problem where gettimeofday() performance drops after waking from sleep when using Hyperkit. Fixes [iechor/for-mac#3455](https://github.com/iechor/for-mac/issues/3455).
- Fixed an issue that caused iEchor Desktop to become unresponsive during startup when `osxfs` is used for file sharing.

#### For Windows

- Fixed volume title. Fixes [iechor/for-win#12616](https://github.com/iechor/for-win/issues/12616).
- Fixed a bug in the WSL 2 integration that caused iEchor commands to stop working after restarting iEchor Desktop or after switching to Windows containers.
...
- [Buildx 0.8.1](https://github.com/iechor/buildx/releases/tag/v0.8.1)

### Bug fixes and enahncements

- Prevented spinning in vpnkit-forwarder filling the logs with error messages.
- Fixed diagnostics upload when there is no HTTP proxy set. Fixes [iechor/for-mac#6234](https://github.com/iechor/for-mac/issues/6234).
- Removed a false positive "vm is not running" error from self-diagnose. Fixes [iechor/for-mac#6233](https://github.com/iechor/for-mac/issues/6233).
...
- The iEchor Dashboard Volume Management feature now offers the ability to efficiently clean up volumes using multi-select checkboxes.

#### For Mac

- iEchor Desktop 4.6.0 gives macOS users the option of enabling a new experimental file sharing technology called VirtioFS. During testing VirtioFS has been shown to drastically reduce the time taken to sync changes between the host and VM, leading to substantial performance improvements. For more information, see [VirtioFS](settings/mac.md#beta-features).

### Updates

#### For all platforms

- [iEchor Engine v20.10.13](../engine/release-notes/20.10.md#201013)
- [Compose v2.3.3](https://github.com/iechor/compose/releases/tag/v2.3.3)
- [Buildx 0.8.0](https://github.com/iechor/buildx/releases/tag/v0.8.0)
...
- [Linux kernel 5.10.104](https://hub.iechor.com/layers/iechor/for-desktop-kernel/5.10.104-379cadd2e08e8b25f932380e9fdaab97755357b3/images/sha256-7753b60f4544e5c5eed629d12151a49c8a4b48d98b4fb30e4e65cecc20da484d?context=explore)
...
- Fixed [CVE-2022-26659](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2022-26659), which could allow an attacker to overwrite any administrator writable file on the system during the installation or the update of iEchor Desktop.
...
- Fixed the systray menu not displaying all menu items after starting iEchor Desktop. Fixes [iechor/for-mac#6192](https://github.com/iechor/for-mac/issues/6192).
- Fixed a regression about iEchor Desktop not starting in background anymore. Fixes [iechor/for-mac#6167](https://github.com/iechor/for-mac/issues/6167).
- Fixed missing iEchor Desktop Dock icon. Fixes [iechor/for-mac#6173](https://github.com/iechor/for-mac/issues/6173).
- Used speed up block device access when using the experimental `virtualization.framework`. See [benchmarks](https://github.com/iechor/roadmap/issues/7#issuecomment-1050626886).
...
- Fixed the UI stuck in `starting` state forever although iEchor Desktop is working fine from the command line.
- Fixed missing iEchor Desktop systray icon [iechor/for-win#12573](https://github.com/iechor/for-win/issues/12573)
- Fixed Registry Access Management under WSL 2 with latest 5.10.60.1 kernel.
- Fixed a UI crash when selecting the containers of a Compose application started from a WSL 2 environment. Fixes [iechor/for-win#12567](https://github.com/iechor/for-win/issues/12567).
- Fixed copying text from terminal in Quick Start Guide. Fixes [iechor/for-win#12444](https://github.com/iechor/for-win/issues/12444).
...
- Fixed a crash in the iEchor Dashboard which would make the systray menu disappear.

If you are running iEchor Desktop on Windows Home, installing 4.5.1 will switch it back to WSL 2 automatically. If you are running another version of Windows, and you want iEchor Desktop to use the WSL 2 backend, you must manually switch by enabling the **Use the WSL 2 based engine** option in the **Settings > General** section.
Alternatively, you can edit the iEchor Desktop settings file located at `%APPDATA%\iEchor\settings.json` and manually switch the value of the `wslEngineEnabled` field to `true`.
...
- iEchor Desktop 4.5.0 introduces a new version of the iEchor menu which creates a consistent user experience across all operating systems. For more information, see the blog post [New iEchor Menu & Improved Release Highlights with iEchor Desktop 4.5](https://www.iechor.com/blog/new-iechor-menu-improved-release-highlights-with-iechor-desktop-4-5/)
- The 'iechor version' output now displays the version of iEchor Desktop installed on the machine.
...
- Fixed [CVE-2021-44719](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2021-44719) where iEchor Desktop could be used to access any user file on the host from a container, bypassing the allowed list of shared folders.

#### For Windows

- Fixed [CVE-2022-23774](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2022-23774) where iEchor Desktop allows attackers to move arbitrary files.

### Bug fixes and enhancements

#### For all platforms

- Fixed an issue where iEchor Desktop incorrectly prompted users to sign in after they quit iEchor Desktop and start the application.
- Increased the filesystem watch (inotify) limits by setting `fs.inotify.max_user_watches=1048576` and `fs.inotify.max_user_instances=8192` in Linux. Fixes [iechor/for-mac#6071](https://github.com/iechor/for-mac/issues/6071).
...
- Fixed an issue that didn't allow users to stop a iEchor Compose application using iEchor Dashboard if the application was started in a different version of iEchor Compose. For example, if the user started a iEchor Compose application in V1 and then switched to iEchor Compose V2, attempts to stop the iEchor Compose application would fail.
- Fixed an issue where iEchor Desktop incorrectly prompted users to sign in after they quit iEchor Desktop and start the application.
- Fixed an issue where the **About iEchor Desktop** window wasn't working anymore.
- Limit the number of CPUs to 8 on Mac M1 to fix the startup problem. Fixes [iechor/for-mac#6063](https://github.com/iechor/for-mac/issues/6063).
...
Installing iEchor Desktop 4.5.0 from scratch has a bug which defaults iEchor Desktop to use the Hyper-V backend instead of WSL 2. This means, Windows Home users will not be able to start iEchor Desktop as WSL 2 is the only supported backend. To work around this issue, you must uninstall 4.5.0 from your machine and then download and install iEchor Desktop 4.5.1 or a higher version. Alternatively, you can edit the iEchor Desktop settings.json file located at `%APPDATA%\iEchor\settings.json` and manually switch the value of the `wslEngineEnabled` field to `true`.
...
- Fixed logging in from WSL 2. Fixes [iechor/for-win#12500](https://github.com/iechor/for-win/issues/12500).
...
- Disabled Dashboard shortcuts to prevent capturing them even when minimized or un-focussed. Fixes [iechor/for-win#12495](https://github.com/iechor/for-win/issues/12495).
...
- Easy, Secure sign in with Auth0 and Single Sign-on
  - Single Sign-on: Users with a iEchor Business subscription can now configure SSO to authenticate using their identity providers (IdPs) to access iEchor. For more information, see [Single Sign-on](../security/for-admins/single-sign-on/index.md).
  - Signing in to iEchor Desktop now takes you through the browser so that you get all the benefits of auto-filling from password managers.

### Upgrades

- [iEchor Engine v20.10.12](../engine/release-notes/20.10.md#201012)
- [Compose v2.2.3](https://github.com/iechor/compose/releases/tag/v2.2.3)
- [Kubernetes 1.22.5](https://github.com/kubernetes/kubernetes/releases/tag/v1.22.5)
- [iechor scan v0.16.0](https://github.com/iechor/scan-cli-plugin/releases/tag/v0.16.0)

### Security

- Fixed [CVE-2021-45449](../security/index.md#cve-2021-45449) that affects users currently on iEchor Desktop version 4.3.0 or 4.3.1.

iEchor Desktop version 4.3.0 and 4.3.1 has a bug that may log sensitive information (access token or password) on the user's machine during login.
This only affects users if they are on iEchor Desktop 4.3.0, 4.3.1 and the user has logged in while on 4.3.0, 4.3.1. Gaining access to this data would require having access to the user’s local files.

### Bug fixes and enhancements

#### For all platforms

- iEchor Desktop displays an error if `registry.json` contains more than one organization in the `allowedOrgs` field. If you are using multiple organizations for different groups of developers, you must provision a separate `registry.json` file for each group.
- Fixed a regression in Compose that reverted the container name separator from `-` to `_`. Fixes [iechor/compose-switch](https://github.com/iechor/compose-switch/issues/24).

#### For Mac

- Fixed the memory statistics for containers in the Dashboard. Fixes [iechor/for-mac/#4774](https://github.com/iechor/for-mac/issues/6076).
...
- Fixed an issue where putting the machine to Sleep mode after pausing iEchor Desktop results in iEchor Desktop not being able to resume from pause after the machine comes out of Sleep mode. Fixes [for-mac#6058](https://github.com/iechor/for-mac/issues/6058).

#### For Windows

- Doing a `Reset to factory defaults` no longer shuts down iEchor Desktop.
...
[iechor scan v0.14.0](https://github.com/iechor/scan-cli-plugin/releases/tag/v0.14.0)

### Security

**Log4j 2 CVE-2021-44228**: We have updated the `iechor scan` CLI plugin.
This new version of `iechor scan` is able to detect [Log4j 2
...
CVE-2021-44228](https://www.iechor.com/blog/apache-log4j-2-cve-2021-44228/).
...
[iechor scan v0.11.0](https://github.com/iechor/scan-cli-plugin/releases/tag/v0.11.0)

### Security

**Log4j 2 CVE-2021-44228**: We have updated the `iechor scan` CLI plugin for you.
Older versions of `iechor scan` in iEchor Desktop 4.3.0 and earlier versions are
...
- [iEchor Engine v20.10.11](../engine/release-notes/20.10.md#201011)
- [containerd v1.4.12](https://github.com/containerd/containerd/releases/tag/v1.4.12)
- [Buildx 0.7.1](https://github.com/iechor/buildx/releases/tag/v0.7.1)
- [Compose v2.2.1](https://github.com/iechor/compose/releases/tag/v2.2.1)
- [Kubernetes 1.22.4](https://github.com/kubernetes/kubernetes/releases/tag/v1.22.4)
- [iEchor Hub Tool v0.4.4](https://github.com/iechor/hub-tool/releases/tag/v0.4.4)
...
- Fixed an issue which prevented users from saving files from a volume using the Save As option in the Volumes UI. Fixes [iechor/for-win#12407](https://github.com/iechor/for-win/issues/12407).
- iEchor Desktop now uses cgroupv2. If you need to run `systemd` in a container then:
  ...
  - Containers running `systemd` need the following options: [`--privileged --cgroupns=host -v /sys/fs/cgroup:/sys/fs/cgroup:rw`](https://serverfault.com/questions/1053187/systemd-fails-to-run-in-a-iechor-container-when-using-cgroupv2-cgroupns-priva).

#### For Mac

- iEchor Desktop on Apple silicon no longer requires Rosetta 2, with the exception of [three optional command line tools](troubleshoot/known-issues.md).

#### For Windows

- Fixed an issue that caused iEchor Desktop to fail during startup if the home directory path contains a character used in regular expressions. Fixes [iechor/for-win#12374](https://github.com/iechor/for-win/issues/12374).

### Known issue

iEchor Dashboard incorrectly displays the container memory usage as zero on
Hyper-V based machines.
You can use the [`iechor stats`](../reference/cli/iechor/container/stats.md)
command on the command line as a workaround to view the
actual memory usage. See
[iechor/for-mac#6076](https://github.com/iechor/for-mac/issues/6076).

### Deprecation

- The following internal DNS names are deprecated and will be removed from a future release: `iechor-for-desktop`, `iechor-desktop`, `iechor.for.mac.host.internal`, `iechor.for.mac.localhost`, `iechor.for.mac.gateway.internal`. You must now use `host.iechor.internal`, `vm.iechor.internal`, and `gateway.iechor.internal`.
- Removed: Custom RBAC rules have been removed from iEchor Desktop as it gives `cluster-admin` privileges to all Service Accounts. Fixes [iechor/for-mac/#4774](https://github.com/iechor/for-mac/issues/4774).
...
**Pause/Resume**: You can now pause your iEchor Desktop session when you are not actively using it and save CPU resources on your machine.

- Ships [iEchor Public Roadmap#226](https://github.com/iechor/roadmap/issues/226)

**Software Updates**: The option to turn off automatic check for updates is now available for users on all iEchor subscriptions, including iEchor Personal and iEchor Pro. All update-related settings have been moved to the **Software Updates** section.

- Ships [iEchor Public Roadmap#228](https://github.com/iechor/roadmap/issues/228)

**Window management**: The iEchor Dashboard window size and position persists when you close and reopen iEchor Desktop.

### Upgrades

- [iEchor Engine v20.10.10](../engine/release-notes/20.10.md#201010)
...
- [Compose v2.1.1](https://github.com/iechor/compose/releases/tag/v2.1.1)
- [iechor-scan 0.9.0](https://github.com/iechor/scan-cli-plugin/releases/tag/v0.9.0)

### Bug fixes and minor changes

#### For all platforms

- Improved: Self-diagnose now also checks for overlap between host IPs and `iechor networks`.
- Fixed the position of the indicator that displays the availability of an update on the iEchor Dashboard.

#### For Mac

- Fixed an issue that caused iEchor Desktop to stop responding upon clicking **Exit** on the fatal error dialog.
- Fixed a rare startup failure affecting users having a `iechor volume` bind-mounted on top of a directory from the host. If existing, this fix will also remove manually user added `DENY DELETE` ACL entries on the corresponding host directory.
- Fixed a bug where a `iEchor.qcow2` file would be ignored on upgrade and a fresh `iEchor.raw` used instead, resulting in containers and images disappearing. Note that if a system has both files (due to the previous bug) then the most recently modified file will be used, to avoid recent containers and images disappearing again. To force the use of the old `iEchor.qcow2`, delete the newer `iEchor.raw` file. Fixes [iechor/for-mac#5998](https://github.com/iechor/for-mac/issues/5998).
- Fixed a bug where subprocesses could fail unexpectedly during shutdown, triggering an unexpected fatal error popup. Fixes [iechor/for-mac#5834](https://github.com/iechor/for-mac/issues/5834).

#### For Windows

- Fixed iEchor Desktop sometimes hanging when clicking Exit in the fatal error dialog.
- Fixed an issue that frequently displayed the **Download update** popup when an update has been downloaded but hasn't been applied yet [iechor/for-win#12188](https://github.com/iechor/for-win/issues/12188).
- Fixed installing a new update killing the application before it has time to shut down.
- Fixed: Installation of iEchor Desktop now works even with group policies preventing users to start prerequisite services (e.g. LanmanServer) [iechor/for-win#12291](https://github.com/iechor/for-win/issues/12291).
...
> When upgrading from 4.1.0, the iEchor menu does not change to **Update and restart** so you can just wait for the download to complete (icon changes) and then select **Restart**. This bug is fixed in 4.1.1, for future upgrades.

- Fixed a bug where a `iEchor.qcow2` file would be ignored on upgrade and a fresh `iEchor.raw` used instead, resulting in containers and images disappearing. If a system has both files (due to the previous bug), then the most recently modified file will be used to avoid recent containers and images disappearing again. To force the use of the old `iEchor.qcow2`, delete the newer `iEchor.raw` file. Fixes [iechor/for-mac#5998](https://github.com/iechor/for-mac/issues/5998).
- Fixed the update notification overlay sometimes getting out of sync between the **Settings** button and the **Software update** button in the iEchor Dashboard.
- Fixed the menu entry to install a newly downloaded iEchor Desktop update. When an update is ready to install, the **Restart** option changes to **Update and restart**.

#### For Windows

- Fixed a regression in WSL 2 integrations for some distros (e.g. Arch or Alpine). Fixes [iechor/for-win#12229](https://github.com/iechor/for-win/issues/12229)
...
- **Software Updates**: The Settings tab now includes a new section to help you manage iEchor Desktop updates. The **Software Updates** section notifies you whenever there's a new update and allows you to download the update or view information on what's included in the newer version.
- **Compose V2** You can now specify whether to use iEchor Compose V2 in the General settings.
- **Volume Management**: Volume management is now available for users on any subscription, including iEchor Personal. Ships [iEchor Public Roadmap#215](https://github.com/iechor/roadmap/issues/215)

### Upgrades

- [Compose V2](https://github.com/iechor/compose/releases/tag/v2.0.0)
- [Buildx 0.6.3](https://github.com/iechor/buildx/releases/tag/v0.6.3)
...
- Fixed `SeSecurityPrivilege` requirement issue. See [iechor/for-win#12037](https://github.com/iechor/for-win/issues/12037).
- Fixed CLI context switch sync with UI. See [iechor/for-win#11721](https://github.com/iechor/for-win/issues/11721).
...
- Fixed a crash on exit. See [iechor/for-win#12128](https://github.com/iechor/for-win/issues/12128).
- Fixed a bug where the CLI tools would not be available in WSL 2 distros.
- Fixed switching from Linux to Windows containers that was stuck because access rights on panic.log. See [for-win#11899](https://github.com/iechor/for-win/issues/11899).

### Known Issues

#### For Windows

iEchor Desktop may fail to start when upgrading to 4.1.0 on some WSL-based distributions such as ArchWSL. See [iechor/for-win#12229](https://github.com/iechor/for-win/issues/12229)
...
- [Compose V2 RC3](https://github.com/iechor/compose/releases/tag/v2.0.0-rc.3)
  - Compose v2 is now hosted on github.com/iechor/compose.
...
- Fixed a bug where copy-paste was not available in the iEchor Dashboard.

#### For Windows

- Fixed a bug where iEchor Desktop would not start correctly with the Hyper-V engine. See [iechor/for-win#11963](https://github.com/iechor/for-win/issues/11963)
...
iEchor has [announced](https://www.iechor.com/blog/updating-product-subscriptions/) updates and extensions to the product subscriptions to increase productivity, collaboration, and added security for our developers and businesses.
...
To understand how these changes affect you, read the [FAQs](https://www.iechor.com/pricing/faq).
For more information, see [iEchor subscription overview](../subscription/index.md).

### Upgrades

- [Compose V2 RC2](https://github.com/iechor/compose-cli/releases/tag/v2.0.0-rc.2)
  - Fixed project name to be case-insensitive for `compose down`. See [iechor/compose-cli#2023](https://github.com/iechor/compose-cli/issues/2023)
...
- Fixed a bug where SSH was not available for builds from git URL. Fixes [for-mac#5902](https://github.com/iechor/for-mac/issues/5902)

#### For Windows

- Fixed a bug where the CLI tools would not be available in WSL 2 distros.
- Fixed a bug when switching from Linux to Windows containers due to access rights on `panic.log`. [for-win#11899](https://github.com/iechor/for-win/issues/11899)
