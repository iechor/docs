...
> **Note**
>
> You do not need to pay to create a iEchor extension. The [iEchor Extension SDK](https://www.npmjs.com/package/@iechor/extension-api-client) is licensed under the Apache 2.0 License and is free to use. Anyone can create new extensions and share them without constraints.
> 
...
- Installing the latest version of iEchor Desktop.
- Setting up the directory with files, including the extension’s source code and the required extension-specific files.
- Creating the `iEchorfile` to build, publish, and run your extension in iEchor Desktop.
- Configuring the metadata file which is required at the root of the image filesystem.
- Building and installing the extension.

For further inspiration, see the other examples in the [samples folder](https://github.com/iechor/extensions-sdk/tree/main/samples).
...
iEchor Desktop displays published extensions in the Extensions Marketplace. The Extensions Marketplace is a curated space where developers can discover extensions to improve their developer experience and upload their own extension to share with the world.
...
If you want to get up and running with creating a iEchor Extension, see the [Quickstart guide](quickstart.md).
...
For an in-depth tutorial of the entire build process, we recommend the following video walkthrough from iEchorCon 2022.
