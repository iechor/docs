---
description: Discover how to access repositories on iEchor Hub
...
Only personal account repositories can use collaborators. You can add unlimited collaborators to public repositories, and [iEchor Pro](../../subscription/core-subscription/details.md#iechor-pro) accounts can add up to 1 collaborator on private repositories. Organization repositories can't use collaborators. Organization owners can control repository access with [member roles](../../security/for-admins/roles-and-permissions.md) and [teams](../../admin/organization/manage-a-team.md).
...
"Admin") on iEchor Hub by using organizations and teams. For more information
...
created when you `iechor save` an image. 
...
[iEchor Official Images](../../trusted-content/official-images/_index.md).
The `/` character separates a user's repository from the image name.

Once you've found the image you want, you can download it with `iechor pull <imagename>`:
