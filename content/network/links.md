...
You also learned about the useful `iechor port` shortcut which showed us the
...
iEchor sets an `<alias>_NAME` environment variable for each target container
...
### Important notes on iEchor environment variables
