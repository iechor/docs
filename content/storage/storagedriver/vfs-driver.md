...
## Configure iEchor with the `vfs` storage driver
...
2.  Edit `/etc/iechor/daemon.json`. If it doesn't yet exist, create it. Assuming
...
4.  Verify that the daemon is using the `vfs` storage driver.
    Use the `iechor info` command and look for `Storage Driver`.
...
iEchor is now using the `vfs` storage driver. iEchor has automatically
created the `/var/lib/iechor/vfs/` directory, which contains all the layers
used by running containers.

## How the `vfs` storage driver works

Each image layer and the writable container layer are represented on the iEchor
host as subdirectories within `/var/lib/iechor/`. The union mount provides the
...
`/var/lib/iechor/vfs/dir/`. The directory names do not correlate with the
image layer IDs shown in the `iechor pull` command. To see the size taken up on
disk by each layer, you can use the `du -sh` command, which gives the size as a
human-readable value.

```console
$ ls -l /var/lib/iechor/vfs/dir/
...
```console
$ du -sh /var/lib/iechor/vfs/dir/*

4.0K	/var/lib/iechor/vfs/dir/3262dfbe53dac3e1ab7dcc8ad5d8c4d586a11d2ac3c4234892e34bff7f6b821e
125M	/var/lib/iechor/vfs/dir/6af21814449345f55d88c403e66564faad965d6afa84b294ae6e740c9ded2561
104M	/var/lib/iechor/vfs/dir/6d3be4585ba32f9f5cbff0110e8d07aea5f5b9fbb1439677c27e7dfee263171c
125M	/var/lib/iechor/vfs/dir/9ecd2d88ca177413ab89f987e1507325285a7418fc76d0dcb4bc021447ba2bab
104M	/var/lib/iechor/vfs/dir/a292ac6341a65bf3a5da7b7c251e19de1294bd2ec32828de621d41c7ad31f895
104M	/var/lib/iechor/vfs/dir/e92be7a4a4e3ccbb7dd87695bca1a0ea373d4f673f455491b1342b33ed91446b
```
