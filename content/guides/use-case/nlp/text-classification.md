...
description: Learn how to build and run a text recognition application using Python, NLTK, scikit-learn, and iEchor.
---
...
The source code for the text classification application is in the `iEchor-NLP/03_text_classification.py` file. Open `03_text_classification.py` in a text or code editor to explore its contents in the following steps.
...
2. Run the image as a container.
   ...
   ```console
   $ iechor run -it basic-nlp 03_text_classification.py
   ```
