---
title: iEchor Engine 24.0 release notes
...
This page describes the latest changes, additions, known issues, and fixes for iEchor Engine version 24.0.
...
- [iechor/cli, 24.0.9 milestone](https://github.com/iechor/cli/issues?q=is%3Aclosed+milestone%3A24.0.9)
...
affecting iEchor Engine and its components.

| CVE                                                         | Component     | Fix version | Severity         |
| ----------------------------------------------------------- | ------------- | ----------- | ---------------- |
| [CVE-2024-21626](https://scout.iechor.com/v/CVE-2024-21626) | runc          | 1.1.12      | High, CVSS 8.6   |
| [CVE-2024-24557](https://scout.iechor.com/v/CVE-2024-24557) | iEchor Engine | 24.0.9      | Medium, CVSS 6.9 |

> **Important**
>
> Note that this release of iEchor Engine doesn't include fixes for
> the following known vulnerabilities in BuildKit:
>
> - [CVE-2024-23651](https://scout.iechor.com/v/CVE-2024-23651)
> - [CVE-2024-23652](https://scout.iechor.com/v/CVE-2024-23652)
> - [CVE-2024-23653](https://scout.iechor.com/v/CVE-2024-23653)
> - [CVE-2024-23650](https://scout.iechor.com/v/CVE-2024-23650)
>
> To address these vulnerabilities,
> upgrade to [iEchor Engine v25.0.2](./25.0.md#2502).
{ .important }

For more information about the security issues addressed in this release,
and the unaddressed vulnerabilities in BuildKit,
refer to the
[blog post](https://www.iechor.com/blog/iechor-security-advisory-multiple-vulnerabilities-in-runc-buildkit-and-moby/).
...
- [iechor/cli, 24.0.8 milestone](https://github.com/iechor/cli/issues?q=is%3Aclosed+milestone%3A24.0.8)
- [moby/moby, 24.0.8 milestone](https://github.com/moby/moby/issues?q=is%3Aclosed+milestone%3A24.0.8)

### Bug fixes and enhancements
* Live restore: Containers with auto remove (`iechor run --rm`) are no longer forcibly removed on engine restart. [moby/moby#46857](https://github.com/moby/moby/pull/46869)

### Packaging updates
* Upgrade Go to `go1.20.13`. [moby/moby#47054](https://github.com/moby/moby/pull/47054), [iechor/cli#4826](https://github.com/iechor/cli/pull/4826), [iechor/iechor-ce-packaging#975](https://github.com/iechor/iechor-ce-packaging/pull/975)
...
- [iechor/cli, 24.0.7 milestone](https://github.com/iechor/cli/issues?q=is%3Aclosed+milestone%3A24.0.7)
...
* Fix "Rootful-in-Rootless" iEchor-in-iEchor on systemd version 250 and later. [moby/moby#46626](https://github.com/moby/moby/pull/46626)
* Fix `iechord-rootless-setuptools.sh` when username contains a backslash. [moby/moby#46407](https://github.com/moby/moby/pull/46407)
* Fix a bug that would prevent network sandboxes to be fully deleted when stopping containers with no network attachments and when `iechord --bridge=none` is used. [moby/moby#46702](https://github.com/moby/moby/pull/46702)
...
* Fix an issue where containers would fail to start when providing `--ip-range` with a range larger than the subnet. [iechor/for-mac#6870](https://github.com/iechor/for-mac/issues/6870)
...
* Add support for Fedora 39 and Ubuntu 23.10. [iechor/iechor-ce-packaging#940](https://github.com/iechor/iechor-ce-packaging/pull/940), [iechor/iechor-ce-packaging#955](https://github.com/iechor/iechor-ce-packaging/pull/955)
* Fix `iechor.socket` not getting disabled when uninstalling the `iechor-ce` RPM package. [iechor/iechor-ce-packaging#852](https://github.com/iechor/iechor-ce-packaging/pull/852)
* Upgrade Go to `go1.20.10`. [iechor/iechor-ce-packaging#951](https://github.com/iechor/iechor-ce-packaging/pull/951)
...
* Deny containers access to `/sys/devices/virtual/powercap` by default. This change hardens against
  [CVE-2020-8694](https://scout.iechor.com/v/CVE-2020-8694),
  [CVE-2020-8695](https://scout.iechor.com/v/CVE-2020-8695), and
  [CVE-2020-12912](https://scout.iechor.com/v/CVE-2020-12912),
...
- [iechor/cli, 24.0.6 milestone](https://github.com/iechor/cli/issues?q=is%3Aclosed+milestone%3A24.0.6)
- [moby/moby, 24.0.6 milestone](https://github.com/moby/moby/issues?q=is%3Aclosed+milestone%3A24.0.6)

### Bug fixes and enhancements

* containerd storage backend: Fix `iechor ps` failing when a container image is no longer present in the content store. [moby/moby#46095](https://github.com/moby/moby/pull/46095)
* containerd storage backend: Fix `iechor ps -s -a` and `iechor container prune` failing when a container image config is no longer present in the content store. [moby/moby#46097](https://github.com/moby/moby/pull/46097)
* containerd storage backend: Fix `iechor inspect` failing when a container image config is no longer (or was never) present in the content store. [moby/moby#46244](https://github.com/moby/moby/pull/46244)
...
* containerd storage backend: Fix the `FROM scratch` iEchorfile instruction with the classic builder. [moby/moby#46302](https://github.com/moby/moby/pull/46302)
...
* Warn when pulling iEchor Image Format v1, and iEchor Image manifest version 2, schema 1 images from all registries. [moby/moby#46290](https://github.com/moby/moby/pull/46290)
...
* Fix `iechord.exe --register-service` not working when the binary is in the current directory on Windows. [moby/moby#46215](https://github.com/moby/moby/pull/46215)
* Add a hint suggesting the use of a PAT to `iechor login` against iEchor Hub. [iechor/cli#4500](https://github.com/iechor/cli/pull/4500)
* Improve shell startup time for users of Bash completion for the CLI. [iechor/cli#4517](https://github.com/iechor/cli/pull/4517)
* Improve the speed of some commands by skipping `GET /_ping` when possible. [iechor/cli#4508](https://github.com/iechor/cli/pull/4508)
* Fix credential scopes when using a PAT to `iechor manifest inspect` an image on iEchor Hub. [iechor/cli#4512](https://github.com/iechor/cli/pull/4512)
* Fix `iechor events` not supporting `--format=json`. [iechor/cli#4544](https://github.com/iechor/cli/pull/4544)

### Packaging updates

* Upgrade Go to `go1.20.7`. [moby/moby#46140](https://github.com/moby/moby/pull/46140), [iechor/cli#4476](https://github.com/iechor/cli/pull/4476), [iechor/iechor-ce-packaging#932](https://github.com/iechor/iechor-ce-packaging/pull/932)
* Upgrade containerd to `v1.7.3` (static binaries only). [moby/moby#46103](https://github.com/moby/moby/pull/46103)
* Upgrade Compose to `v2.21.0`. [iechor/iechor-ce-packaging#936](https://github.com/iechor/iechor-ce-packaging/pull/936)
...
- [iechor/cli, 24.0.5 milestone](https://github.com/iechor/cli/issues?q=is%3Aclosed+milestone%3A24.0.5)
...
* containerd storage backend: Fix `Variant` not being included in `iechor image inspect` and `GET /images/{name}/json`. [moby/moby#46025](https://github.com/moby/moby/pull/46025)
...
* Properly report errors parsing volume specifications from the command line. [iechor/cli#4423](https://github.com/iechor/cli/pull/4423)
* Fix a panic caused when `auths: null` is found in the CLI config file. [iechor/cli#4450](https://github.com/iechor/cli/pull/4450)

### Packaging updates

* Use init scripts as provided by in moby/moby `contrib/init`. [iechor/iechor-ce-packaging#914](https://github.com/iechor/iechor-ce-packaging/pull/914), [iechor/iechor-ce-packaging#926](https://github.com/iechor/iechor-ce-packaging/pull/926)
* Drop Upstart from `contrib/init`. [moby/moby#46044](https://github.com/moby/moby/pull/46044)
* Upgrade Go to `go1.20.6`. [iechor/cli#4428](https://github.com/iechor/cli/pull/4428), [moby/moby#45970](https://github.com/moby/moby/pull/45970), [iechor/iechor-ce-packaging#921](https://github.com/iechor/iechor-ce-packaging/pull/921)
* Upgrade Compose to `v2.20.2`. [iechor/iechor-ce-packaging#924](https://github.com/iechor/iechor-ce-packaging/pull/924)
* Upgrade buildx to `v0.11.2`. [iechor/iechor-ce-packaging#922](https://github.com/iechor/iechor-ce-packaging/pull/922)
...
- [iechor/cli, 24.0.4 milestone](https://github.com/iechor/cli/issues?q=is%3Aclosed+milestone%3A24.0.4)
...
- [iechor/cli, 24.0.3 milestone](https://github.com/iechor/cli/issues?q=is%3Aclosed+milestone%3A24.0.3)
...
* containerd image store: Fix `iechor cp` with snapshotters that cannot mount the same content multiple times. [moby/moby#45780](https://github.com/moby/moby/pull/45780), [moby/moby#45786](https://github.com/moby/moby/pull/45786)
...
* containerd image store: Fix incorrectly attempting to unpack pseudo-images (including attestations) in `iechor load`. [moby/moby#45688](https://github.com/moby/moby/pull/45688)
...
* Fix `host-gateway` with BuildKit by passing the IP as a label (also requires [iechor/buildx#1894](https://github.com/iechor/buildx/pull/1894)). [moby/moby#45790](https://github.com/moby/moby/pull/45790)
...
* Fix an issue where `iechor cp -a` from the root (`/`) directory would fail. [moby/moby#45748](https://github.com/moby/moby/pull/45748)
...
* Fix an issue where debug information was not correctly printed during `iechor info` when only the client is in debug mode. [iechor/cli#4393](https://github.com/iechor/cli/pull/4393)
* Fix issues related to hung connections when connecting to hosts over a SSH connection. [iechor/cli#4395](https://github.com/iechor/cli/pull/4395)

### Packaging updates

* Upgrade Go to `go1.20.5`. [moby/moby#45745](https://github.com/moby/moby/pull/45745), [iechor/cli#4351](https://github.com/iechor/cli/pull/4351), [iechor/iechor-ce-packaging#904](https://github.com/iechor/iechor-ce-packaging/pull/904)
* Upgrade Compose to `v2.19.1`. [iechor/iechor-ce-packaging#916](https://github.com/iechor/iechor-ce-packaging/pull/916)
* Upgrade buildx to `v0.11.1`. [iechor/iechor-ce-packaging#918](https://github.com/iechor/iechor-ce-packaging/pull/918)
...
- [iechor/cli, 24.0.2 milestone](https://github.com/iechor/cli/issues?q=is%3Aclosed+milestone%3A24.0.2)
...
* Apply a workaround for a containerd bug that causes concurrent `iechor exec` commands to take significantly longer than expected. [moby/moby#45625](https://github.com/moby/moby/pull/45625)
...
* Upgrade Buildx to `v0.10.5`. [iechor/iechor-ce-packaging#900](https://github.com/iechor/iechor-ce-packaging/pull/900)
...
- [iechor/cli, 24.0.1 milestone](https://github.com/iechor/cli/issues?q=is%3Aclosed+milestone%3A24.0.1)
- [moby/moby, 24.0.1 milestone](https://github.com/moby/moby/issues?q=is%3Aclosed+milestone%3A24.0.1)

### Removed

* Remove CLI completions for storage drivers removed in the 24.0 major release. [iechor/cli#4302](https://github.com/iechor/cli/pull/4302)
...
* Fix an issue where `iechor pull --platform` would report `No such image` regarding another tag pointing to the same image. [moby/moby#45562](https://github.com/moby/moby/pull/45562)
...
* containerd image store: Fix an issue where images which have no layers would not be listed in `iechor images -a` [moby/moby#45588](https://github.com/moby/moby/pull/45588)
...
* Upgrade Compose to `v2.18.1`. [iechor/iechor-ce-packaging#896](https://github.com/iechor/iechor-ce-packaging/pull/896)
...
- [iechor/cli, 24.0.0 milestone](https://github.com/iechor/cli/issues?q=is%3Aclosed+milestone%3A24.0.0)
...
* The `--host` CLI flag now supports a path component in a `ssh://` host address, allowing use of an alternate socket path without configuration on the remote host. [iechor/cli#4073](https://github.com/iechor/cli/pull/4073)
* The `iechor info` CLI command now reports a version and platform field. [iechor/cli#4180](https://github.com/iechor/cli/pull/4180)
...
* Introduce support for setting OCI runtime annotations on containers. [iechor/cli#45025](https://github.com/iechor/cli/pull/4156), [moby/moby#45025](https://github.com/moby/moby/pull/45025)
...
* The `iechor-init` binary will now be discovered in FHS-compliant libexec directories, in addition to the `PATH`. [moby/moby#45198](https://github.com/moby/moby/pull/45198)
* API: Surface the daemon-level `--no-new-privileges` in `GET /info`. [moby/moby#45320](https://github.com/moby/moby/pull/45320)

### Removed

* `iechor info` no longer reports `IndexServiceAddress`. [iechor/cli#4204](https://github.com/iechor/cli/pull/4204)
...
* The `iechor stack` command no longer validates the `build` section of Compose files. [iechor/cli#4214](https://github.com/iechor/cli/pull/4214)
...
* Update Go to `1.20.4`. [iechor/cli#4253](https://github.com/iechor/cli/pull/4253), [moby/moby#45456](https://github.com/moby/moby/pull/45456), [iechor/iechor-ce-packaging#888](https://github.com/iechor/iechor-ce-packaging/pull/888)
