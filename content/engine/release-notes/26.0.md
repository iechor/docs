---
title: iEchor Engine 26.0 release notes
...
This page describes the latest changes, additions, known issues, and fixes for iEchor Engine version 26.0.
...
- [iechor/cli, 26.0.2 milestone](https://github.com/iechor/cli/issues?q=is%3Aclosed+milestone%3A26.0.2)
- [moby/moby, 26.0.2 milestone](https://github.com/moby/moby/issues?q=is%3Aclosed+milestone%3A26.0.2)
- Deprecated and removed features, see [Deprecated Features](https://github.com/iechor/cli/blob/v26.0.2/docs/deprecated.md).
...
- [iechor/cli, 26.0.1 milestone](https://github.com/iechor/cli/issues?q=is%3Aclosed+milestone%3A26.0.1)
- [moby/moby, 26.0.1 milestone](https://github.com/moby/moby/issues?q=is%3Aclosed+milestone%3A26.0.1)
- Deprecated and removed features, see [Deprecated Features](https://github.com/iechor/cli/blob/v26.0.1/docs/deprecated.md).
...
- Remove erroneous `platform` from image `config` OCI descriptor in `iechor save` output. [moby/moby#47694](https://github.com/moby/moby/pull/47694)
- containerd image store: OCI archives produced by `iechor save` will now have a non-empty `mediaType` field in `index.json` [moby/moby#47701](https://github.com/moby/moby/pull/47701)
...
- Update Go runtime to 1.21.9 [moby/moby#47671](https://github.com/moby/moby/pull/47671), [iechor/cli#4987](https://github.com/iechor/cli/pull/4987)
- Update Compose to [v1.26.1 ](https://github.com/iechor/compose/releases/tag/v2.26.1), [iechor/iechor-ce-packaging#1009](https://github.com/iechor/iechor-ce-packaging/pull/1009)
...
- [iechor/cli, 26.0.0 milestone](https://github.com/iechor/cli/issues?q=is%3Aclosed+milestone%3A26.0.0)
- [moby/moby, 26.0.0 milestone](https://github.com/moby/moby/issues?q=is%3Aclosed+milestone%3A26.0.0)
- Deprecated and removed features, see [Deprecated Features](https://github.com/iechor/cli/blob/v26.0.0/docs/deprecated.md).
...
- Add `volume-subpath` support to the mount flag (`--mount type=volume,...,volume-subpath=<subpath>`). [iechor/cli#4331](https://github.com/iechor/cli/pull/4331)
- Accept `=` separators and `[ipv6]` in compose files for `iechor stack deploy`. [iechor/cli#4860](https://github.com/iechor/cli/pull/4860)
- rootless: Add support for enabling host loopback by setting the `IECHORD_ROOTLESS_ROOTLESSKIT_DISABLE_HOST_LOOPBACK` environment variable to `false` (defaults to `true`). This lets containers connect to the host by using IP address `10.0.2.2`. [moby/moby#47352](https://github.com/moby/moby/pull/47352)
- containerd image store: `iechor image ls` no longer creates duplicates entries for multi-platform images. [moby/moby#45967](https://github.com/moby/moby/pull/45967)
...
- Ensure that a generated MAC address is not restored when a container is restarted, but a configured MAC address is preserved. [moby/moby#47233](https://github.com/moby/moby/pull/47233)
  ...
  > **Warning**
  >
  > Containers created using iEchor Engine 25.0.0 may have duplicate MAC addresses, they must be re-created.
...
- Fix `ADD` iEchorfile instruction failing with `lsetxattr <file>: operation not supported` when unpacking archive with xattrs onto a filesystem that doesn't support them. [moby/moby#47175](https://github.com/moby/moby/pull/47175)
- Fix `iechor container start` failing when used with `--checkpoint`. [moby/moby#47456](https://github.com/moby/moby/pull/47456)
...
- Print hint when invoking `iechor image ls` with ambiguous argument. [iechor/cli#4849](https://github.com/iechor/cli/pull/4849)
- Cleanup `@iechor_cli_[UUID]` files on OpenBSD. [iechor/cli#4862](https://github.com/iechor/cli/pull/4862)
- Add explicit [deprecation notice](https://github.com/iechor/cli/blob/v26.0.0/docs/deprecated.md#unauthenticated-tcp-connections) message when using remote TCP connections without TLS. [iechor/cli#4928](https://github.com/iechor/cli/pull/4928), [moby/moby#47556](https://github.com/moby/moby/pull/47556)
- Use IPv6 nameservers from the host's `resolv.conf` as upstream resolvers for iEchor Engine's internal DNS, rather than listing them in the container's `resolv.conf`. [moby/moby#47512](https://github.com/moby/moby/pull/47512)
...
- Update Buildx to [v0.13.1](https://github.com/iechor/buildx/releases/tag/v0.13.1). [iechor/iechor-ce-packaging#1000](https://github.com/iechor/iechor-ce-packaging/pull/1000)
- Update Compose to [v2.25.0](https://github.com/iechor/compose/releases/tag/v2.25.0). [iechor/iechor-ce-packaging#1002](https://github.com/iechor/iechor-ce-packaging/pull/1002)
...
- Remove `Container` and `ContainerConfig` fields from the `GET /images/{name}/json` response. [moby/moby#47430](https://github.com/moby/moby/pull/47430)
- Deprecate the ability to accept remote TCP connections without TLS. [Deprecation notice](https://github.com/iechor/cli/tree/v26.0.0/deprecation.md#unauthenticated-tcp-connections) [iechor/cli#4928](https://github.com/iechor/cli/pull/4928) [moby/moby#47556](https://github.com/moby/moby/pull/47556).
...
- Remove the deprecated `github.com/iechor/iechor/pkg/loopback` package. [moby/moby#47128](https://github.com/moby/moby/pull/47128)
...
- cli/command/container: remove deprecated `NewStartOptions()` [iechor/cli#4811](https://github.com/iechor/cli/pull/4811)
- cli/command: remove deprecated `iEchorCliOption`, `InitializeOpt` [iechor/cli#4810](https://github.com/iechor/cli/pull/4810)
