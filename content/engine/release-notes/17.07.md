---
title: iEchor Engine 17.07 release notes
toc_min: 1
toc_max: 2
---
...
* Add support for proxy configuration in config.json [iechor/cli#93](https://github.com/iechor/cli/pull/93)
* Enable pprof/debug endpoints by default [moby/moby#32453](https://github.com/moby/moby/pull/32453)
* Passwords can now be passed using `STDIN` using the new  `--password-stdin` flag on `iechor login` [iechor/cli#271](https://github.com/iechor/cli/pull/271)
+ Add `--detach` to iechor scale [iechor/cli#243](https://github.com/iechor/cli/pull/243)
* Prevent `iechor logs --no-stream` from hanging due to non-existing containers [moby/moby#34004](https://github.com/moby/moby/pull/34004)
- Fix `iechor stack ps` printing error to `stdout` instead of `stderr` [iechor/cli#298](https://github.com/iechor/cli/pull/298)
* Fix progress bar being stuck on `iechor service create` if an error occurs during deploy [iechor/cli#259](https://github.com/iechor/cli/pull/259)
* Improve presentation of progress bars in interactive mode [iechor/cli#260](https://github.com/iechor/cli/pull/260) [iechor/cli#237](https://github.com/iechor/cli/pull/237)
* Print a warning if `iechor login --password` is used, and recommend `--password-stdin` [iechor/cli#270](https://github.com/iechor/cli/pull/270)
* Make API version negotiation more robust [moby/moby#33827](https://github.com/moby/moby/pull/33827)
* Hide `--detach` when connected to daemons older than iEchor 17.05 [iechor/cli#219](https://github.com/iechor/cli/pull/219)
+ Add `scope` filter in `GET /networks/(id or name)` [moby/moby#33630](https://github.com/moby/moby/pull/33630)

### Builder

* Implement long running interactive session and sending build context incrementally [moby/moby#32677](https://github.com/moby/moby/pull/32677) [iechor/cli#231](https://github.com/iechor/cli/pull/231) [moby/moby#33859](https://github.com/moby/moby/pull/33859)
* Warn on empty continuation lines [moby/moby#33719](https://github.com/moby/moby/pull/33719)
- Fix `.iechorignore` entries with a leading `/` not matching anything [moby/moby#32088](https://github.com/moby/moby/pull/32088)
...
* Remove container locks on `iechor ps` [moby/moby#31273](https://github.com/moby/moby/pull/31273)
* Store container names in memdb [moby/moby#33886](https://github.com/moby/moby/pull/33886)
* Fix race condition between `iechor exec` and `iechor pause` [moby/moby#32881](https://github.com/moby/moby/pull/32881)
...
- Fix run `iechor rename <container-id> new_name` concurrently resulting in the having multiple names [moby/moby#33940](https://github.com/moby/moby/pull/33940)
* Fix file-descriptor leak and error handling [moby/moby#33713](https://github.com/moby/moby/pull/33713)
- Fix SIGSEGV when running containers [iechor/cli#303](https://github.com/iechor/cli/pull/303)
...
* Sort swarm stacks and nodes using natural sorting [iechor/cli#315](https://github.com/iechor/cli/pull/315)
...
* Fix error during service creation if a network with the same name exists both as "local" and "swarm" scoped network [iechor/cli#184](https://github.com/iechor/cli/pull/184)
