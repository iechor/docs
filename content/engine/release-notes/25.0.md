---
title: iEchor Engine 25.0 release notes
...
This page describes the latest changes, additions, known issues, and fixes for iEchor Engine version 25.0.
...
- [iechor/cli, 25.0.5 milestone](https://github.com/iechor/cli/issues?q=is%3Aclosed+milestone%3A25.0.5)
...
- rootless: fix `open /etc/iechor/plugins: permission denied`. [moby/moby#47587](https://github.com/moby/moby/pull/47587)
- Fix multiple parallel `iechor build` runs leaking disk space. [moby/moby#47527](https://github.com/moby/moby/pull/47527)
...
- [iechor/cli, 25.0.4 milestone](https://github.com/iechor/cli/issues?q=is%3Aclosed+milestone%3A25.0.4)
...
- Fix `iechor start` failing when used with `--checkpoint` [moby/moby#47466](https://github.com/moby/moby/pull/47466)
...
- Upgrade Compose to v2.24.7. [iechor/iechor-ce-packaging#998](https://github.com/moby/moby/pull/998)
- Upgrade Buildx to v0.13.0. [iechor/iechor-ce-packaging#997](https://github.com/moby/moby/pull/997)
...
- [iechor/cli, 25.0.3 milestone](https://github.com/iechor/cli/issues?q=is%3Aclosed+milestone%3A25.0.3)
- [moby/moby, 25.0.3 milestone](https://github.com/moby/moby/issues?q=is%3Aclosed+milestone%3A25.0.3)

### Bug fixes and enhancements

- containerd image store: Fix a bug where `iechor image history` would fail if a manifest wasn't found in the content store. [moby/moby#47348](https://github.com/moby/moby/pull/47348)
- Ensure that a generated MAC address is not restored when a container is restarted, but a configured MAC address is preserved. [moby/moby#47304](https://github.com/moby/moby/pull/47304)
  ...
  > **Note**
  >
  > - Containers created with iEchor Engine version 25.0.0 may have duplicate MAC addresses.
  >   They must be re-created.
  > - Containers with user-defined MAC addresses created with iEchor Engine versions 25.0.0 or 25.0.1
  >   receive new MAC addresses when started using iEchor Engine version 25.0.2.
  >   They must also be re-created.

- Fix `iechor save <image>@<digest>` producing an OCI archive with index without manifests. [moby/moby#47294](https://github.com/moby/moby/pull/47294)
...
- Removed support for Ubuntu Lunar (23.04). [iechor/ce-packaging#986](https://github.com/iechor/iechor-ce-packaging/pull/986)
...
- [iechor/cli, 25.0.2 milestone](https://github.com/iechor/cli/issues?q=is%3Aclosed+milestone%3A25.0.2)
...
| [CVE-2024-23651](https://scout.iechor.com/v/CVE-2024-23651) | BuildKit      | 1.12.5      | High, CVSS 8.7   |
| [CVE-2024-23652](https://scout.iechor.com/v/CVE-2024-23652) | BuildKit      | 1.12.5      | High, CVSS 8.7   |
| [CVE-2024-23653](https://scout.iechor.com/v/CVE-2024-23653) | BuildKit      | 1.12.5      | High, CVSS 7.7   |
| [CVE-2024-23650](https://scout.iechor.com/v/CVE-2024-23650) | BuildKit      | 1.12.5      | Medium, CVSS 5.5 |
| [CVE-2024-24557](https://scout.iechor.com/v/CVE-2024-24557) | iEchor Engine | 25.0.2      | Medium, CVSS 6.9 |
...
refer to the [blog post](https://www.iechor.com/blog/iechor-security-advisory-multiple-vulnerabilities-in-runc-buildkit-and-moby/).
...
- Upgrade Compose to v2.24.5. [iechor/iechor-ce-packaging#985](https://github.com/iechor/iechor-ce-packaging/pull/985)
...
- [iechor/cli, 25.0.1 milestone](https://github.com/iechor/cli/issues?q=is%3Aclosed+milestone%3A25.0.1)
- [moby/moby, 25.0.1 milestone](https://github.com/moby/moby/issues?q=is%3Aclosed+milestone%3A25.0.1)

### Bug fixes and enhancements

- API: Fix incorrect HTTP status code for containers with an invalid network configuration created before upgrading to iEchor Engine v25.0. [moby/moby#47159](https://github.com/moby/moby/pull/47159)
...
- Upgrade Compose to `2.24.2`. [iechor/iechor-ce-packaging#981](https://github.com/iechor/iechor-ce-packaging/pull/981)
...
- [iechor/cli, 25.0.0 milestone](https://github.com/iechor/cli/issues?q=is%3Aclosed+milestone%3A25.0.0)
- [moby/moby, 25.0.0 milestone](https://github.com/moby/moby/issues?q=is%3Aclosed+milestone%3A25.0.0)

> **Note**
>
> In earlier versions of iEchor Engine, recursive mounts (submounts) would
...
>
> ```console
> $ iechor run --mount type=bind,src=SRC,dst=DST,readonly,bind-recursive=writable IMAGE
> ```
>
...
- The daemon now uses systemd's default `LimitNOFILE`. In earlier versions of
  iEchor Engine, this limit was set to `infinity`. This would cause issues with
  ...
  This change currently only affects build containers created with `iechor
  build` when using BuildKit with the `iechor` driver. Future versions of
...
- Add support for CDI devices under Linux. [moby/moby#45134](https://github.com/moby/moby/pull/45134), [iechor/cli#4510](https://github.com/iechor/cli/pull/4510), [moby/moby#46004](https://github.com/moby/moby/pull/46004)
- Add an additional interval to be used by healthchecks during the container start period. [moby/moby#40894](https://github.com/moby/moby/pull/40894), [iechor/cli#4405](https://github.com/iechor/cli/pull/4405), [moby/moby#45965](https://github.com/moby/moby/pull/45965)
- Add a `--log-format` flag to `iechord` to control the logging format: text (default) or JSON. [moby/moby#45737](https://github.com/moby/moby/pull/45737)
...
- Add support for filtering images based on timestamp with `iechor image ls --filter=until=<timestamp>`. [moby/moby#46577](https://github.com/moby/moby/pull/46577)
...
- Add an error message for when specifying a iEchorfile filename with `-f`, and also using `stdin`. [iechor/cli#4346](https://github.com/iechor/cli/pull/4346)
- Add support for `mac-address` and `link-local-ip` fields in `--network` long format. [iechor/cli#4419](https://github.com/iechor/cli/pull/4419)
- Add support for specifying multiple `--network` flags with `iechor container create` and `iechor run`. [moby/moby#45906](https://github.com/moby/moby/pull/45906)
...
- Live restore: Containers with auto remove (`iechor run --rm`) are no longer forcibly removed on engine restart. [moby/moby#46857](https://github.com/moby/moby/pull/46857)
...
- Fix `com.iechor.network.host_ipv4` option when IPv6 and ip6tables are enabled. [moby/moby#46446](https://github.com/moby/moby/pull/46446)
...
- The `iechor image save` tarball output is now OCI compliant. [moby/moby#44598](https://github.com/moby/moby/pull/44598)
...
- containerd image store: Fix a bug related to the `ONBUILD`, `MAINTAINER`, and `HEALTHCHECK` iEchorfile instructions. [moby/moby#46313](https://github.com/moby/moby/pull/46313)
...
- containerd image store: Fix `iechor images` showing intermediate layers by default. [moby/moby#46423](https://github.com/moby/moby/pull/46423)
...
- containerd image store: Improve `iechor pull` progress output. [moby/moby#46412](https://github.com/moby/moby/pull/46412)
...
- containerd image store: `iechor image ls` now shows the correct image creation time and date. [moby/moby#46719](https://github.com/moby/moby/pull/46719)
...
- containerd image store: Add support for pulling all tags (`iechor pull -a`). [moby/moby#46618](https://github.com/moby/moby/pull/46618)
...
- Upgrade Compose to `2.24.1`. [iechor/iechor-ce-packaging#980](https://github.com/iechor/iechor-ce-packaging/pull/980)
...
- Upgrade Buildx to v0.12.1. [iechor/iechor-ce-packaging#979](https://github.com/iechor/iechor-ce-packaging/pull/979)
...
- Remove deprecated orchestrator options. [iechor/cli#4366](https://github.com/iechor/cli/pull/4366)
...
- Remove warning for deprecated `~/.iechorcfg` file. [iechor/cli#4281](https://github.com/iechor/cli/pull/4281)
...
- Deprecate `IsAutomated` field and `is-automated` filter for `iechor search`. [Deprecation notice](../deprecated.md#isautomated-field-and-is-automated-filter-on-iechor-search)
- API: Deprecate `Container` and `ContainerConfig` properties for `/images/{id}/json` (`iechor image inspect`). [moby/moby#46939](https://github.com/moby/moby/pull/46939)
...
valid Linux `xattr` namespace prefixes, which causes an error when iEchor
attempts to process these files. For example, if you try to use a tar file with
an `ADD` iEchorfile instruction, you might see an error message similar to the
following:
...
include more context in [v25.0.1](#2501), but the limitation in iEchor being
...
As a workaround, if you need to use tar files with iEchor generated on macOS,
you can either:
