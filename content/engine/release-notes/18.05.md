---
title: iEchor Engine 18.05 release notes
toc_min: 1
toc_max: 2
---
...
- Fix `iechor stack deploy` reference flag. [iechor/cli#981](https://github.com/iechor/cli/pull/981)
...
+ Add bash completion for `secret|config create --template-driver`. [iechor/cli#1004](https://github.com/iechor/cli/pull/1004)
+ Add fish completions for iechor trust subcommand. [iechor/cli#984](https://github.com/iechor/cli/pull/984)
- Fix --format example for iechor history. [iechor/cli#980](https://github.com/iechor/cli/pull/980)
- Fix error with merge composefile with networks. [iechor/cli#983](https://github.com/iechor/cli/pull/983)
...
- networkdb: User write lock in handleNodeEvent.  [iechor/libnetwork#2136](https://github.com/iechor/libnetwork/pull/2136)
...
* LCOW: Implement `iechor save`. [moby/moby#36599](https://github.com/moby/moby/pull/36599)
...
* Revert unencryted storage warning prompt. [iechor/cli#1008](https://github.com/iechor/cli/pull/1008)
...
* RoleManager will remove detected nodes from the cluster membership [iechor/swarmkit#2548](https://github.com/iechor/swarmkit/pull/2548)
* Scheduler/TaskReaper: handle unassigned tasks marked for shutdown [iechor/swarmkit#2574](https://github.com/iechor/swarmkit/pull/2574)
* Avoid predefined error log. [iechor/swarmkit#2561](https://github.com/iechor/swarmkit/pull/2561)
* Task reaper should delete tasks with removed slots that were not yet assigned. [iechor/swarmkit#2557](https://github.com/iechor/swarmkit/pull/2557)
* Agent reports FIPS status. [iechor/swarmkit#2587](https://github.com/iechor/swarmkit/pull/2587)
- Fix: timeMutex critical operation outside of critical section. [iechor/swarmkit#2603](https://github.com/iechor/swarmkit/pull/2603)
