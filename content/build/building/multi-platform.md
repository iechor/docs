...
The following example uses a single `iEchorfile` to build an Alpine image with
...
Inspect the image using [`iechor buildx imagetools` command](../../reference/cli/iechor/buildx/imagetools/_index.md):
