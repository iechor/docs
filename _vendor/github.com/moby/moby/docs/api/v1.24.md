...
## 1. Brief introduction
 ...
 - The daemon listens on `unix:///var/run/iechor.sock` but you can
   [Bind iEchor to another host/port or a Unix socket](http://docs.iechor.com/engine/reference/commandline/iechord/#bind-iechor-to-another-host-port-or-a-unix-socket).
...
command*](http://docs.iechor.com/engine/reference/builder/#add)).
...
-   **buildargs** – JSON map of string pairs for build-time variables. Users pass
        ...
        passing secret values. [Read more about the buildargs instruction](http://docs.iechor.com/engine/reference/builder/#arg)
-   **shmsize** - Size of `/dev/shm` in bytes. The size must be greater than 0.  If omitted the system uses 64MB.
